        ...
        <el-col :span="6">
          <div class="out-border">
            ...
            <div class="color-main address-content">
              <a href="https://github.com/JellyB/mall-swarm">mall-swarm</a>
            </div>
          </div>
        </el-col>
        <el-col :span="6">
          <div class="out-border">
            ...
            <div class="color-main address-content">
              <a href="https://github.com/JellyB/mall-admin-web">mall-admin-web</a>
            </div>
          </div>
        </el-col>
        <el-col :span="6">
          <div class="out-border">
            ...
            <div class="color-main address-content">
              <a href="https://github.com/JellyB/mall-learning">mall-learning</a>
            </div>
          </div>
        </el-col>
      </el-row>
